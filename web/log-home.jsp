					...
					<div class="row" style="margin-top:50px;">		
						<div class="col-lg-5" style="margin-left: 50px;">
							...
							<div class="sparkline16-list shadow-reset mg-t-30" style="margin-top:0px;" >				
								<div class="sparkline16-graph" style="height:100px;" >
									<form action="/log" method="post">
										<div class="col-lg-4">
											<span>Data di inizio ricerca</span>
											<input type="date" name="selezioneDataInizioLog"></input> 	
										</div>
										<div class="col-lg-4">
											<span>Data di fine ricerca</span>
											<input type="date" name="selezioneDataFineLog"></input> 	
										</div>
										<div class="col-lg-4">
											<span></span>
							...
							<div class="sparkline9-list shadow-reset mg-tb-30" style="margin-top: 0px;">				
								<div class="sparkline8-graph">
									<div class="static-table-list" style="height:460px;overflow:scroll">
										<table class="table">
											<tbody>
												<tr>
						...
						<div class="col-lg-5" style="margin-left: 50px;">
							<div class="alert-title">
								<h2>Anomalie del Log</h2>
							</div>
							<div class="sparkline16-list shadow-reset mg-t-30" style="margin-top:0px;" >				
								<div class="sparkline16-graph" style="height:100px;" >
									<form action="/log" method="post">
										<div class="col-lg-4">
											<span>Data di inizio analisi</span>
											<input type="date" name="selezioneDataInizioAnalisi"></input> 	
										</div>
										<div class="col-lg-4">
											<span>Data di fine analisi</span>
											<input type="date" name="selezioneDataFineAnalisi"></input> 	
										</div>
										<div class="col-lg-4">
											<span></span>
