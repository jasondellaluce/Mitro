							...
							<div class="sparkline9-list shadow-reset mg-tb-30" style="margin-top: 0px;">
								<div class="sparkline9-graph dashone-comment">
									<div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
										<form id="adminpro-form" class="adminpro-form" action='/professore-voti?selAtt=<%= request.getParameter("selAtt") %>' method="post"> 
															...
															if(request.getAttribute("listaStudenti") != null) {
																...
																%>
																	<tr>
																		...
																		<td><input name='checkVoto<%= i %>' type="text" <%= request.getAttribute("voto" + i) == null ? "" : "disabled" %> value='<%= request.getAttribute("voto" + i) == null ? "" : request.getAttribute("voto" + i) %>'></td>
																	</tr>
																<%
																}
															}
											...
											<div class="compose-email"> 
												<br>   
												<button type='submit' class="btn btn-custon-rounded-three btn-default" style="width:100%;" >Conferma voti</button>
											</div>
										</form> 
									</div>
